...
INSERT INTO customers (tenant_id, customer_number, first_name, last_name, date_of_birth, pan_number, aadhaar_number, mobile_number, email, address, city, state, pin_code, kyc_verified, kyc_verified_date, kyc_verified_by, cibil_score, customer_type, is_active, is_pep, rekyc_due, kyc_risk_category, branch_id, monthly_income, max_borrowing_limit, employment_type, employer_name, address_same_as_permanent, video_kyc_done, version, created_at, created_by)
VALUES ('DEFAULT', 'CUST002', 'Priya', 'Patel', '1990-07-22', 'FGHIJ5678K', '234567890123', '9876543211', 'priya.patel@email.com', '456 Ring Road', 'Delhi', 'Delhi', '110002', 1, '2026-02-10', 'admin', 820, 'INDIVIDUAL', 1, 0, 0, 'MEDIUM', 2, 250000.00, 10000000.00, 'SALARIED', 'Infosys Limited', 1, 0, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO customers (tenant_id, customer_number, first_name, last_name, date_of_birth, pan_number, aadhaar_number, mobile_number, email, address, city, state, pin_code, kyc_verified, cibil_score, customer_type, is_active, is_pep, rekyc_due, kyc_risk_category, branch_id, monthly_income, max_borrowing_limit, employment_type, employer_name, address_same_as_permanent, video_kyc_done, version, created_at, created_by)
VALUES ('DEFAULT', 'CUST003', 'Arun', 'Kumar', '1978-11-05', 'KLMNO9012P', '345678901234', '9876543212', 'arun.kumar@email.com', '789 Brigade Road', 'Bangalore', 'Karnataka', '560002', 0, 580, 'INDIVIDUAL', 1, 0, 0, 'MEDIUM', 3, 80000.00, 2000000.00, 'SELF_EMPLOYED', NULL, 1, 0, 0, CURRENT_TIMESTAMP, 'SYSTEM');
...
INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'TERM_LOAN', 'Term Loan - Unsecured', 'TERM_LOAN', 'Standard unsecured term loan for salaried individuals', 'INR', 'ACTUAL_365', 'FIXED', 8.0000, 24.0000, 2.0000, 50000.00, 5000000.00, 6, 84, 'MONTHLY', '1001', '1002', '1100', '4001', '4002', '4003', '5001', '1003', '5002', '2100', 1, 'INTEREST_FIRST', 0, 1.0000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'HOME_LOAN', 'Home Loan - Secured', 'TERM_LOAN', 'Housing finance for residential property purchase', 'INR', 'ACTUAL_365', 'FLOATING', 6.5000, 12.0000, 2.0000, 500000.00, 50000000.00, 12, 360, 'MONTHLY', '1001', '1002', '1100', '4001', '4002', '4003', '5001', '1003', '5002', '2100', 1, 'INTEREST_FIRST', 0, 0.5000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'GOLD_LOAN', 'Gold Loan - Secured', 'DEMAND_LOAN', 'Loan against gold ornaments with bullet repayment', 'INR', 'ACTUAL_365', 'FIXED', 7.0000, 15.0000, 2.0000, 10000.00, 2500000.00, 3, 12, 'BULLET', '1001', '1002', '1100', '4001', '4002', '4003', '5001', '1003', '5002', '2100', 1, 'INTEREST_FIRST', 1, 0.2500, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');
...
INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'SAVINGS', 'Savings Account - Regular', 'CASA_SAVINGS', 'Individual savings account per RBI norms. Interest: 4% p.a. daily product, credited quarterly.', 'INR', 'ACTUAL_365', 'FIXED', 4.0000, 4.0000, 0.0000, 5000.00, 0.00, 0, 0, 'QUARTERLY', '2010', '5010', '1100', '5010', '4002', '4003', '5010', '2500', '5002', '2100', 1, 'INTEREST_FIRST', 0, 0.0000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'SAVINGS_PMJDY', 'Savings - PMJDY (Zero Balance)', 'CASA_SAVINGS', 'Pradhan Mantri Jan Dhan Yojana zero-balance savings account. Interest: 4% p.a.', 'INR', 'ACTUAL_365', 'FIXED', 4.0000, 4.0000, 0.0000, 0.00, 0.00, 0, 0, 'QUARTERLY', '2010', '5010', '1100', '5010', '4002', '4003', '5010', '2500', '5002', '2100', 1, 'INTEREST_FIRST', 0, 0.0000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'SAVINGS_NRI', 'Savings - NRE/NRO', 'CASA_SAVINGS', 'NRI savings account per FEMA guidelines. Interest: 3.5% p.a.', 'INR', 'ACTUAL_365', 'FIXED', 3.5000, 3.5000, 0.0000, 10000.00, 0.00, 0, 0, 'QUARTERLY', '2010', '5010', '1100', '5010', '4002', '4003', '5010', '2500', '5002', '2100', 1, 'INTEREST_FIRST', 0, 0.0000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');

INSERT INTO product_master (tenant_id, product_code, product_name, product_category, description, currency_code, interest_method, interest_type, min_interest_rate, max_interest_rate, default_penal_rate, min_loan_amount, max_loan_amount, min_tenure_months, max_tenure_months, repayment_frequency, gl_loan_asset, gl_interest_receivable, gl_bank_operations, gl_interest_income, gl_fee_income, gl_penal_income, gl_provision_expense, gl_provision_npa, gl_write_off_expense, gl_interest_suspense, is_active, repayment_allocation, prepayment_penalty_applicable, processing_fee_pct, interest_tiering_enabled, product_status, config_version, version, created_at, created_by)
VALUES ('DEFAULT', 'CURRENT', 'Current Account - Business', 'CASA_CURRENT', 'Business current account. Zero interest per RBI norms. Min balance INR 10,000.', 'INR', 'ACTUAL_365', 'FIXED', 0.0000, 0.0000, 0.0000, 10000.00, 0.00, 0, 0, 'MONTHLY', '2020', '5010', '1100', '5010', '4002', '4003', '5010', '2500', '5002', '2100', 1, 'INTEREST_FIRST', 0, 0.0000, 0, 'ACTIVE', 1, 0, CURRENT_TIMESTAMP, 'SYSTEM');
