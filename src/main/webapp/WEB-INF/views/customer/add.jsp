        ...
        <div class="card-body">
            <form method="post" action="${pageContext.request.contextPath}/customer/add" class="fv-form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6"><label class="form-label">Email</label><input type="email" name="email" class="form-control" value="<c:out value='${customer.email}'/>" maxlength="200" tabindex="20" /></div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4"><input type="text" name="pinCode" class="form-control" data-fv-type="pincode" value="<c:out value='${customer.pinCode}'/>" maxlength="6" pattern="[0-9]{6}" title="6-digit PIN" inputmode="numeric" placeholder="PIN Code" tabindex="23" /></div>
                </div>
