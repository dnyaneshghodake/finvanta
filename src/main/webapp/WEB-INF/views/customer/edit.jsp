        ...
        <div class="card-body">
            <form method="post" action="${pageContext.request.contextPath}/customer/edit/${customer.id}" class="fv-form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3"><label class="form-label">KYC Risk Category</label><span class="fv-help-icon" data-fv-help="Per RBI KYC Section 16: LOW=10yr re-KYC, MEDIUM=8yr, HIGH=2yr">?</span><select name="kycRiskCategory" class="form-select" tabindex="3"><option value="LOW" ${customer.kycRiskCategory == 'LOW' ? 'selected' : ''}>Low</option><option value="MEDIUM" ${customer.kycRiskCategory == 'MEDIUM' ? 'selected' : ''}>Medium</option><option value="HIGH" ${customer.kycRiskCategory == 'HIGH' ? 'selected' : ''}>High</option></select></div>
                    <div class="col-md-3"><label class="form-label">PEP</label><span class="fv-help-icon" data-fv-help="Per RBI KYC Direction: PEP requires Enhanced Due Diligence and mandatory HIGH risk">?</span><div class="form-check mt-2"><input type="hidden" name="_pep" value="on" /><input type="checkbox" name="pep" value="true" class="form-check-input" id="pepEdit" ${customer.pep ? 'checked' : ''} tabindex="4" /><label class="form-check-label" for="pepEdit">Politically Exposed Person</label></div></div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4 fv-mandatory-group"><label class="form-label fv-required">Father's Name</label><span class="fv-help-icon" data-fv-help="Per CERSAI CKYC v2.0: mandatory for INDIVIDUAL-type customers. Correctable during re-KYC.">?</span><input type="text" name="fatherName" class="form-control" value="<c:out value='${customer.fatherName}'/>" required maxlength="200" tabindex="10" /></div>
                    <div class="col-md-4 fv-mandatory-group"><label class="form-label fv-required">Mother's Name</label><span class="fv-help-icon" data-fv-help="Per CERSAI CKYC v2.0: mandatory for INDIVIDUAL-type customers. Correctable during re-KYC.">?</span><input type="text" name="motherName" class="form-control" value="<c:out value='${customer.motherName}'/>" required maxlength="200" tabindex="11" /></div>
                ...
                <div class="fv-section-body">
                <div class="row mb-3">
                    <div class="col-md-4 fv-mandatory-group"><label class="form-label fv-required">Mobile Number</label><input type="text" name="mobileNumber" class="form-control" data-fv-type="mobile" value="<c:out value='${customer.mobileNumber}'/>" required maxlength="10" pattern="[6-9][0-9]{9}" title="10-digit mobile" inputmode="numeric" tabindex="15" /></div>
                    <div class="col-md-4"><label class="form-label">Email</label><input type="email" name="email" class="form-control" value="<c:out value='${customer.email}'/>" maxlength="200" tabindex="16" /></div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4"><label class="form-label">PIN Code</label><input type="text" name="pinCode" class="form-control" data-fv-type="pincode" value="<c:out value='${customer.pinCode}'/>" maxlength="6" pattern="[0-9]{6}" title="6-digit PIN" inputmode="numeric" placeholder="PIN Code" tabindex="19" /></div>
                </div>
                ...
                <div class="fv-section-body">
                <div class="row mb-3">
                    <div class="col-md-3"><label class="form-label">Monthly Income (INR)</label><input type="number" name="monthlyIncome" class="form-control" data-fv-type="amount" value="${customer.monthlyIncome}" step="0.01" min="0" tabindex="25" /></div>
                    <div class="col-md-3"><label class="form-label">Max Borrowing Limit (INR)</label><input type="number" name="maxBorrowingLimit" class="form-control" data-fv-type="amount" value="${customer.maxBorrowingLimit}" step="0.01" min="0" tabindex="26" /></div>
                ...
                <button type="submit" class="btn btn-fv-primary mt-2" data-confirm="Save changes to this customer record?"><i class="bi bi-check-circle"></i> Save Changes <span class="fv-kbd">F2</span></button>
                <a href="${pageContext.request.contextPath}/customer/view/${customer.id}" class="btn btn-outline-secondary mt-2 ms-2" data-fv-cancel="${pageContext.request.contextPath}/customer/view/${customer.id}"><i class="bi bi-x-circle"></i> Cancel <span class="fv-kbd">F3</span></a>
            </form>
        </div>
    </div>
</div>
