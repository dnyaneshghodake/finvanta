    ...
    <div class="fv-card">
        ...
        <div class="card-body">
            <form method="post" action="${pageContext.request.contextPath}/customer/edit/${customer.id}" class="fv-form">
                ...
                <div class="row mb-3">
                    <div class="col-md-4"><label class="form-label">Father's Name</label><input type="text" name="fatherName" class="form-control" value="<c:out value='${customer.fatherName}'/>" maxlength="200" tabindex="10" /></div>
                    <div class="col-md-4"><label class="form-label">Mother's Name</label><input type="text" name="motherName" class="form-control" value="<c:out value='${customer.motherName}'/>" maxlength="200" tabindex="11" /></div>
