        ...
        <div class="card-body">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/products/${product.id}/edit" class="fv-form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2"><label class="form-label">Min Rate % *</label><input type="number" name="minInterestRate" class="form-control" required data-fv-type="rate" step="0.01" data-fv-max-field="maxInterestRate" data-fv-label="Min Rate" value="${product.minInterestRate}"/></div>
                    <div class="col-md-2"><label class="form-label">Max Rate % *</label><input type="number" name="maxInterestRate" class="form-control" required data-fv-type="rate" step="0.01" data-fv-label="Max Rate" value="${product.maxInterestRate}"/></div>
                    <div class="col-md-2"><label class="form-label">Penal Rate %</label><input type="number" name="defaultPenalRate" class="form-control" data-fv-type="penal-rate" step="0.01" value="${product.defaultPenalRate}"/></div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3"><label class="form-label">Processing Fee %</label><input type="number" name="processingFeePct" class="form-control" data-fv-type="rate" step="0.01" value="${product.processingFeePct}"/></div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2"><label class="form-label">Default Spread %</label><input type="number" name="defaultSpread" class="form-control" data-fv-type="rate" step="0.01" value="${product.defaultSpread}"/></div>
