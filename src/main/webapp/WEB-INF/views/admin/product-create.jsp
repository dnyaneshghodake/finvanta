        ...
        <div class="card-body">
            <form method="post" action="${pageContext.request.contextPath}/admin/products/create" class="fv-form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2"><label class="form-label">Min Rate % *</label><input type="number" name="minInterestRate" class="form-control" required data-fv-type="rate" step="0.01" data-fv-max-field="maxInterestRate" data-fv-label="Min Rate" value="${not empty product.minInterestRate ? product.minInterestRate : '8.00'}"/></div>
                    <div class="col-md-2"><label class="form-label">Max Rate % *</label><input type="number" name="maxInterestRate" class="form-control" required data-fv-type="rate" step="0.01" data-fv-label="Max Rate" value="${not empty product.maxInterestRate ? product.maxInterestRate : '24.00'}"/></div>
                    <div class="col-md-2"><label class="form-label">Penal Rate %</label><input type="number" name="defaultPenalRate" class="form-control" data-fv-type="penal-rate" step="0.01" value="${not empty product.defaultPenalRate ? product.defaultPenalRate : '2.00'}"/></div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-2"><label class="form-label">Default Spread %</label><input type="number" name="defaultSpread" class="form-control" data-fv-type="rate" step="0.01" placeholder="e.g., 2.50"/></div>
