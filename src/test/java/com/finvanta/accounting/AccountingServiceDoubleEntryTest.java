...
class AccountingServiceDoubleEntryTest {
    ...
    void setUp() {
        ...
        // Constructor: (journalEntryRepo, glMasterRepo, glBranchBalanceRepo, branchRepo, auditService, ledgerService, batchRepo, glBranchBalanceBootstrap)
        accountingService = new AccountingService(null, null, null, null, null, null, null, null);
    }
