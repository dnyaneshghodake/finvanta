...
class ApiExceptionHandlerTest {
    ...
    class OptimisticLockTests {
        ...
        @Test
        @DisplayName("Returns 409 with VERSION_CONFLICT errorCode")
    ...
    @Nested
    @DisplayName("BusinessException → status mapping")
    class BusinessExceptionTests {

        @Test
        @DisplayName("NOT_FOUND error codes map to 404")
        void notFoundCodes() {
        ...
        @Test
        @DisplayName("CONFLICT error codes map to 409")
        void conflictCodes() {
        ...
        @Test
        @DisplayName("UNPROCESSABLE_ENTITY error codes map to 422")
        ...
        @Test
        @DisplayName("FORBIDDEN error codes map to 403")
        void forbiddenCodes() {
        ...
        @Test
        @DisplayName("Unknown error codes default to 400")
