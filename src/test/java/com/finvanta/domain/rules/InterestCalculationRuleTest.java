...
class InterestCalculationRuleTest {
    ...
    class DailyAccrualTests {
        ...
        void standardAccrual_30Days() {
            ...
            BigDecimal result = rule.calculateDailyAccrual(account,
    ...
    class EmiTests {
        ...
        void standardEmi_12Months() {
            BigDecimal emi = rule.calculateEmi(
                new BigDecimal("1000000"), new BigDecimal("10.0000"), 12);
        ...
        void longTenureEmi() {
            BigDecimal emi = rule.calculateEmi(
                new BigDecimal("5000000"), new BigDecimal("8.5000"), 240);
        ...
        void zeroPrincipal_returnsZero() {
            BigDecimal emi = rule.calculateEmi(
                BigDecimal.ZERO, new BigDecimal("10.0000"), 12);
        ...
        void zeroTenure_returnsZero() {
            BigDecimal emi = rule.calculateEmi(
                new BigDecimal("1000000"), new BigDecimal("10.0000"), 0);
            assertEquals(BigDecimal.ZERO, emi);
        }
        ...
        void emiAlwaysPositive() {
            BigDecimal emi = rule.calculateEmi(
                new BigDecimal("1000000"), new BigDecimal("24.0000"), 360);
    ...
    class PenalInterestTests {
        ...
        void standardPenal() {
            ...
            BigDecimal result = rule.calculatePenalInterest(account,
                LocalDate.of(2024, 1, 1), LocalDate.of(2024, 1, 31));
